...
function show_popup(title, message, type = 'info')
{
    if (type !== 'danger') {
        type = 'info';
    }
        ...
        <div id="${id}" class="visible popup_wrapper col-lg-6 col-md-8 col-10">
            <div class="row h-100">
                <div class="popup_icon bg-${type}">
                    <img class="w-75" src="assets/svg/${type}.svg" alt="">
                </div>
                ...
                <div class="button_wrapper bg-light">
                    <img class="popup_closer" data-id="${id}" src="assets/svg/close_dimgray.svg" alt="">
                </div>
